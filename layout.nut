...
AF.prefs.l1.push([
{v = 7.2, varname = "OVERMENUBUTTON", glyph = 0xea54, title = "Context menu button", help = "Chose the button to open the game context menu", options = ["None", "Select", "Custom 1", "Custom 2", "Custom 3", "Custom 4", "Custom 5", "Custom 6", "Custom 7", "Custom 8", "Custom 9", "Custom 10"], values = ["none", "select", "custom1", "custom2", "custom3", "custom4", "custom5", "custom6", "custom7", "custom8", "custom9", "custom10"], selection = 1},
{v = 7.2, varname = "UTILITYMENUBUTTON", glyph = 0xea54, title = "Utility menu button", help = "Chose the button to open the utility menu", options = ["None", "Up", "Custom 1", "Custom 2", "Custom 3", "Custom 4", "Custom 5", "Custom 6", "Custom 7", "Custom 8", "Custom 9", "Custom 10"], values =["none", "up", "custom1", "custom2", "custom3", "custom4", "custom5", "custom6", "custom7", "custom8", "custom9", "custom10"], selection = 1},
...
{v = 7.6, varname = "CATEGORYBUTTON", glyph = 0xea54, title = "Category menu button", help = "Chose the button to use to open the list of game categories", options = ["None", "Custom 1", "Custom 2", "Custom 3", "Custom 4", "Custom 5", "Custom 6", "Custom 7", "Custom 8", "Custom 9", "Custom 10"], values = ["none", "custom1", "custom2", "custom3", "custom4", "custom5", "custom6", "custom7", "custom8", "custom9", "custom10"], selection = 0},
{v = 7.6, varname = "MULTIFILTERBUTTON", glyph = 0xea54, title = "Multifilter menu button", help = "Chose the button to use to open the menu for dynamic filtering of romlist", options = ["None", "Custom 1", "Custom 2", "Custom 3", "Custom 4", "Custom 5", "Custom 6", "Custom 7", "Custom 8", "Custom 9", "Custom 10"], values = ["none", "custom1", "custom2", "custom3", "custom4", "custom5", "custom6", "custom7", "custom8", "custom9", "custom10"], selection = 0},
{v = 14.2, varname = "FAVBUTTON", glyph = 0xea54, title = "Show favorites button", help = "Chose the button to use to toggle favorite filtering", options = ["None", "Custom 1", "Custom 2", "Custom 3", "Custom 4", "Custom 5", "Custom 6", "Custom 7", "Custom 8", "Custom 9", "Custom 10"], values = ["none", "custom1", "custom2", "custom3", "custom4", "custom5", "custom6", "custom7", "custom8", "custom9", "custom10"], selection = 0},
{v = 0.0, varname = "", glyph = -1, title = "Sound", selection = AF.req.liner},
{v = 12.5, varname = "VOLUMEBUTTON", glyph = 0xea54, title = "Volume button", help = "Chose the button to use to change system volume", options = ["None", "Custom 1", "Custom 2", "Custom 3", "Custom 4", "Custom 5", "Custom 6", "Custom 7", "Custom 8", "Custom 9", "Custom 10"], values = ["none", "custom1", "custom2", "custom3", "custom4", "custom5", "custom6", "custom7", "custom8", "custom9", "custom10"], selection = 0},
...
{v = 13.7, varname = "MONITORMEDIA1", glyph = 0xe915, title = "Main media source", help = "Select the artwork source to be used on secondary monitor", options = ["marquee", "logo", "snap"], values =["marquee", "wheel", "snap"], selection = 0}
{v = 13.7, varname = "MONITORMEDIA2", glyph = 0xe915, title = "Alternate media source", help = "Select the artwork source to be used on secondary monitor in case first one is not present", options = ["marquee", "logo", "snap"], values =["marquee", "wheel", "snap"], selection = 1}
])
...
{v = 0.0, varname = "", glyph = -1, title = "Options", selection = AF.req.liner},
...
{v = 16.8, varname = "ARCADESSMEDIA", glyph = 0xe9c4, title = "Arcade media scraper", help = "Arcade games madia can be scraped from ScreenScraper when no ArcadeDataBase data is present", options = ["ADB and SS", "ADB Only"], values= [true, false], selection = 0},
{v = 16.8, varname = "ARCADESSHISTORY", glyph = 0xe9c4, title = "Arcade history scraper", help = "Arcade games history data can be scraped using ArcadeDataBase or ScreenScraper", options = ["SS Only", "ADB Only"], values= [true, false], selection = 0},
...
function getallgamesdb(logopic) {
	...
	fe.overlay.splash_message("") //TEST162 keep for compatibility with WSL
...
hist_text.descr.time_constant = 58
